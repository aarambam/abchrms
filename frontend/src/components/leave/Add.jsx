  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md">
        ...
        <form onSubmit={handleSubmit}>
            <div className="flex flex-col space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="startDate" onChange={handleChange} className="mt-1 p-2 border w-full border border-gray-300 rounded-md" required />
                    </div>
                    {/* To Date */}
                    <div>
            ...
            <button tye="submit" className="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md">Add Leave</button>
        </form>
    </div>
  )
}
