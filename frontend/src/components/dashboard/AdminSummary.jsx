...
import { FaBuilding, FaCheckCircle, FaFileAlt, FaMoneyBillWave, FaTimesCircle, FaHourglassHalf, FaUsers } from 'react-icons/fa'
  ...
  return (
    <div className='p-6'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <SummaryCard icon={<FaMoneyBillWave />} text="Monthly salary" number={summary.totalSalary} color="bg-blue-600" />
        </div>
        <div className="mt-12">
            <h4 className="text-center text-2xl font-bold">Leave Details</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <SummaryCard icon={<FaFileAlt />} text="Leave Applied" number={summary.leaveSummary.appliedFor} color="bg-gray-600" />
